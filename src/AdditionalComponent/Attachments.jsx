...
const Attachments = ({ onFilesAdded, existingFiles = [] }) => {
  const [uploadedFolders, setUploadedFolders] = useState(existingFiles);
  ...
  const handleFileChange = (event) => {
    ...
    onFilesAdded(updatedFiles); // Pass the raw File objects to the parent component
  };
